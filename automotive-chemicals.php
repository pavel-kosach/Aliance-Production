<?php $page_title = 'Автомобильная химия';?>
    ...
    <div class="container">
      <div class="expert-content">
        <div class="expert-img">
          <picture>
          <source type="image/webp" srcset="img/contracts-avtohim.webp">
          <source type="image/jpeg" srcset="img/contracts-avtohim.jpg">
          <img class="expert-logo" src="img/contracts-avtohim.jpg" alt="Контрактное производство автомобильной химии">
          </picture>
        </div>
    ...
    <div class="container">
      <div class="our-production-wrapper">
        <div class="our-production-description">
          <div class="seporator"></div>
            <h2 class="default-title">Изготовление автохимии</h2>
        ...
        <div class="our-production-img">
          ...
          <img class="our-production-picture" src="img/avtohim-production-photo.jpg" alt="Наше производство">
          </picture>
      </div>
      </div>
    </div>
